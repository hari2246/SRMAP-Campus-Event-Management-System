// src/components/dashboard/organiserDashboard.js
            ...
            <CardContent>
              ...
              {events.map((event, index) => (
                <Box key={index} display="flex" justifyContent="space-between" my={2}>
                  <Box>
                    <Typography variant="subtitle1" fontWeight="medium">{event.name}</Typography>
          ...
          <Card sx={{ backgroundColor: '#f3e8ff' }}>
            <CardContent>
              ...
              <Button fullWidth variant="outlined" color="primary" 
                sx={{ my: 1 }} 
                component={Link} 
                to="/volunteer/request" startIcon={<VolunteerActivismIcon />}>
                Request Volunteers
              </Button>
            </CardContent>
          </Card>
